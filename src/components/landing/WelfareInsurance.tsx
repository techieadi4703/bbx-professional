...
export const WelfareInsurance = () => {
  ...
  return (
    <section className="py-10 md:py-24 bg-[#1c1c1a] text-white overflow-hidden relative">
      {/* Background pattern */}
      <div 
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 relative z-10">
        <Reveal width="100%">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12 border-t border-white/10 pt-8 md:pt-16">
            {items.map((item, i) => (
              <RevealItem key={i}>
                <div className="flex flex-col text-left bg-white/5 p-4 md:p-0 rounded-xl md:rounded-none md:bg-transparent">
                  <div className="w-10 h-10 md:w-14 md:h-14 rounded-full bg-[#735c00]/10 flex items-center justify-center mb-4 md:mb-6 text-[#735c00]">
