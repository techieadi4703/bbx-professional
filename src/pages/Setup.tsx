...
export default function ProfessionalSetup() {
  ...
  return (
    <Layout>
      ...
      <div className="bg-surface text-on-surface min-h-screen font-body w-full relative overflow-hidden flex flex-col items-center justify-start py-8 md:py-24">
        ...
        <div className="w-full max-w-2xl px-6 relative z-10">
          <div className="text-center mb-8">
            ...
            <p className="text-sm font-body text-on-surface-variant leading-relaxed max-w-md mx-auto">
          ...
          <motion.div 
            ...
            className="bg-surface-container-lowest border border-border p-4 md:p-10 rounded-2xl shadow-sm hover:border-secondary transition-colors"
          >
            <div className="flex items-center gap-2 mb-6 pb-4 border-b border-border">
              <ShieldCheck className="w-5 h-5 text-secondary" />
              <h2 className="text-sm font-bold uppercase tracking-widest text-on-surface">Identity & Workspace</h2>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5 sm:space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full pl-11 pr-4 py-2 bg-surface-container-low border border-transparent focus:border-secondary rounded-lg text-sm font-bold outline-none transition-colors" 
                    />
                  </div>
                </div>

                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase tracking-widest text-on-surface-variant">Profession</label>
                  <Select required value={form.profession} onValueChange={(val) => setForm({...form, profession: val})}>
                    <SelectTrigger className="w-full h-[38px] sm:h-[42px] bg-surface-container-low border-transparent focus:border-secondary rounded-lg font-bold text-sm">
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold uppercase tracking-widest text-on-surface-variant">Address (Optional)</label>
                <div className="relative">
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold uppercase tracking-widest text-on-surface-variant">Professional Bio (Optional)</label>
                <textarea 
                  maxLength={300} 
                  value={form.bio} 
                  ...
                  rows={2} 
                  className="w-full px-4 py-3 bg-surface-container-low border border-transparent focus:border-secondary rounded-lg text-sm font-bold outline-none transition-colors resize-none" 
                />
              </div>
              ...
              <button 
                type="submit" 
                disabled={isLoading} 
                className="w-full py-3 mt-2 bg-primary text-primary-foreground rounded-lg font-bold hover:bg-secondary transition-colors flex items-center justify-center gap-2 text-sm shadow-md"
              >
